...
class InvoiceController extends Controller
{
    ...
    public function saveBatch(Request $request)
    {
        ...
        $message=''.$student->name.' has been invoiced kes.'.number_format($invoice->amount,2).' for '.$invoice->narrative.'. Please make a payment using paybill number: 000000 Account name: '.$student->name.'-'.$student->school->name.'.';
